...
public class enforcer_services_frag  extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.btn_LTOservices){
            AlertDialog.Builder mBuilder = new AlertDialog.Builder(enforcer_services_frag.this);
