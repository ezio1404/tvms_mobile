...
public class driver_services_frag extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private static String URL_ADDCLEARANCE="http://192.168.1.51/tvms/addclearance.php";
...
//        btn_CTS.setOnClickListener(this);
        ...
        driver_id =user.get(driverSessionManager.DRIVER_ID);
...
//            Toast.makeText(this,"shit",Toast.LENGTH_LONG).show();
            ...
            View mView=getLayoutInflater().inflate(R.layout.driver_lto_services,null);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_LOADAGENCY,
                response -> {
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(driver_services_frag.this,"Error "+e.toString(),Toast.LENGTH_SHORT).show();

                    }
                }
                , error -> Toast.makeText(driver_services_frag.this,"Error "+error.toString(),Toast.LENGTH_SHORT).show());
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_ADDCLEARANCE,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            String success = jsonObject.getString("success");
                            if(success.equals("1")){
                                Toast.makeText(driver_services_frag.this, "Successfully added to Clearance", Toast.LENGTH_SHORT).show();
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(driver_services_frag.this, "Error!" + error.toString(), Toast.LENGTH_SHORT).show();
